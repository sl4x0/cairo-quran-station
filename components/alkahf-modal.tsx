      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              className="glass-panel-emerald rounded-3xl w-full max-w-4xl max-h-[85vh] overflow-hidden pointer-events-auto border-2 border-emerald-500/30 glow-emerald"
            ...
            >
              <div className="relative p-8">
                ...
                <div className="text-center mb-8">
                  <h2 className="text-3xl md:text-4xl font-bold text-emerald-400 mb-2">سورة الكهف</h2>
                  <p className="text-emerald-300/80 font-orbitron text-sm">Surah Al-Kahf (The Cave)</p>
                  <p className="text-muted-foreground text-sm mt-2">First 10 Verses</p>
                </div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="flex-shrink-0 w-10 h-10 rounded-full bg-emerald-950/50 border border-emerald-500/30 flex items-center justify-center">
                          <span className="text-emerald-400 font-orbitron text-sm">{verse.number}</span>
                        </div>
                        <div className="flex-1 space-y-3">
                          <p className="text-2xl md:text-3xl text-foreground leading-relaxed text-right">
                            {verse.arabic}
                          </p>
                          <p className="text-sm text-emerald-300/70 leading-relaxed" dir="ltr">
                            {verse.translation}
                          </p>
                        </div>
                      </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-emerald-400/60 text-sm">May Allah accept your recitation</p>
                </div>
              </div>
            </motion.div>
          </div>
