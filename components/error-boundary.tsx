      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 p-4">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">نعتذر عن هذا الإزعاج. يرجى تحديث الصفحة للمحاولة مرة أخرى.</p>
            <button
              onClick={() => window.location.reload()}
              className="glass-panel px-8 py-4 rounded-full font-bold text-primary hover:bg-primary/10 transition-all glow-gold w-full min-h-[44px]"
